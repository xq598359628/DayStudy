...
/**
 * Created by zhongke on 2016/12/8.
 */
public class BadgeView extends TextView {
    ...
    private void init() {
        ...
        setBackground(9, Color.parseColor("#e74c39"));
    ...
    public void setTargetView(View target, View view) {
        if (getParent() != null) {
            ((ViewGroup) getParent()).removeView(this);
        }
        ...
        if (target.getParent() instanceof FrameLayout) {
            ...
            badgeContainer.setId(R.id.msg_container_view);
            RelativeLayout.LayoutParams layoutParams = (RelativeLayout.LayoutParams) view.getLayoutParams();
            layoutParams.addRule(RelativeLayout.LEFT_OF, badgeContainer.getId());
