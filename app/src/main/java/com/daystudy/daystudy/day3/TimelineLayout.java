...
public class TimelineLayout extends LinearLayout {
    ...
    public TimelineLayout(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        int iconRes = ta.getResourceId(R.styleable.TimelineLayout_icon_src, R.drawable.a);
    ...
    private void drawBetweenLine(Canvas canvas) {
        //从开始的点到最后的图标之间，画一条线
        canvas.drawLine(mFirstX, mFirstY + mPointSize, mLastX, mLastY - mPointSize, mLinePaint);
